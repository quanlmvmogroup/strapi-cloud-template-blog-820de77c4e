  ...
  const variantClass =
    variant === 'simple'
      ...
      : variant === 'outline'
        ...
        : variant === 'primary'
          ? 'bg-green-700 relative z-10 hover:bg-green-600/90  border border-secondary text-white text-sm md:text-sm transition font-medium duration-200  rounded-md px-4 py-2  flex items-center justify-center shadow-[0px_-1px_0px_0px_#FFFFFF60_inset,_0px_1px_0px_0px_#FFFFFF60_inset'
          : variant === 'muted'
